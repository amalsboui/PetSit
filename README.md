...
🚀 Tech Stack
LayerTechnologyBackendNestJS + TypeScriptFrontendAngular (Standalone Components)DatabasePostgreSQL + TypeORMAuthJWT + bcryptAIGitHub Models (GPT-4o via OpenAI SDK)
